...
public class EthicsReport {
    ...
    public EthicsReport(UUID id, UUID caseId, String mode, String category, String subject, String narrative, String locale, Instant now){
        this.id=id;this.caseId=caseId;this.mode=mode;this.category=category;this.subject=subject;this.narrative=narrative;this.locale=locale;this.createdAt=now;
    }
