 ...
 *
 * <p>Records whether the backend-redacted agent {@code details.detection}
 * payload satisfied the catalog item's detection rule after the install
 * attempt terminated. Independent from {@link CommandResultStatus}: an
