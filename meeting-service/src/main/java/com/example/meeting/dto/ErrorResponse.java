...
/**
 * Canonical error envelope. Copied from endpoint-admin-service so the
 * cross-service error response shape ({@code error} / {@code message} /
 * {@code fieldErrors} / {@code meta.traceId}) is identical.
 */
