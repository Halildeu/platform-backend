...
/** Service-local transactional outbox row for meeting.consent.revoked. */
@Entity
@Table(name = "consent_event_outbox")
public class ConsentEventOutbox {
    ...
    private ConsentEventOutboxStatus status = ConsentEventOutboxStatus.PENDING;
    ...
    public ConsentEventOutboxStatus getStatus() { return status; }
    public void setStatus(ConsentEventOutboxStatus status) { this.status = status; }
