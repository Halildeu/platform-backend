...
class SmsSendResultTest {
    ...
    void acceptedRequiresNonBlankProviderMsgId() {
        assertThatThrownBy(() ->
            new SmsSendResult(SmsSendResult.SmsSendStatus.ACCEPTED,
                SmsFailureClass.NONE, "jetsms", null, null, 1, "ISO-8859-9"))
            .isInstanceOf(IllegalArgumentException.class)
            .hasMessageContaining("providerMsgId");

        assertThatThrownBy(() ->
            new SmsSendResult(SmsSendResult.SmsSendStatus.ACCEPTED,
                SmsFailureClass.NONE, "jetsms", "  ", null, 1, "ISO-8859-9"))
            .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void segmentCountCannotBeNegative() {
        assertThatThrownBy(() ->
            new SmsSendResult(SmsSendResult.SmsSendStatus.FAILED,
                SmsFailureClass.INVALID_PHONE, "jetsms", null, "31", -1, null))
            .isInstanceOf(IllegalArgumentException.class)
    ...
    void acceptedRequiresPositiveSegmentCount() {
        assertThatThrownBy(() ->
            new SmsSendResult(SmsSendResult.SmsSendStatus.ACCEPTED,
                SmsFailureClass.NONE, "jetsms", "jetsms-1", null, 0, "ISO-8859-9"))
    ...
    void retryRejectsPositiveSegmentCount() {
        assertThatThrownBy(() ->
            new SmsSendResult(SmsSendResult.SmsSendStatus.RETRY,
                SmsFailureClass.HTTP_5XX, "jetsms", null, "http503", 2, "ISO-8859-9"))
            .isInstanceOf(IllegalArgumentException.class)
            .hasMessageContaining("FAILED/RETRY");
    }
    ...
    void statusAndFailureClassRequiredNonNull() {
        assertThatThrownBy(() ->
            new SmsSendResult(null, SmsFailureClass.NONE, "jetsms", "jetsms-1", null, 1, null))
            .isInstanceOf(IllegalArgumentException.class)
            .hasMessageContaining("status");

        assertThatThrownBy(() ->
            new SmsSendResult(SmsSendResult.SmsSendStatus.ACCEPTED, null, "jetsms", "jetsms-1", null, 1, null))
            .isInstanceOf(IllegalArgumentException.class)
